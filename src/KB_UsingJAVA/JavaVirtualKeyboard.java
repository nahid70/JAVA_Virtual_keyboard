...
public class JavaVirtualKeyboard implements ActionListener, ItemListener {
	...
	public JavaVirtualKeyboard() {
		...
		frame = new JFrame();
		frame.setTitle("((  JAVA Virtual Keyboard  ))");
		...
		// label image
		label_icon = new ImageIcon(getClass().getResource("label.png"));
		label_img = new JLabel(label_icon);
		frame.add(label_img).setBounds(756, 127, 168, 60);
